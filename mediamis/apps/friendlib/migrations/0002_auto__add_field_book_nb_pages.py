...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Book.nb_pages'
        db.add_column('friendlib_book', 'nb_pages', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Book.nb_pages'
        db.delete_column('friendlib_book', 'nb_pages')
